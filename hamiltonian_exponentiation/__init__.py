...
def exp_ham(src, t, plus_or_minus = -1.0, precision=1e-18, scalar_cutoff = 27.5, print_method=False, trotterize_by=1.0):
...
def exponentiate_ham(src, t, plus_or_minus = -1.0, precision=1e-18, scalar_cutoff = 27.5, print_method=False):
    """

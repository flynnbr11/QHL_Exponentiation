...
#matrix_sizes = [1,2,3]
high=13 # max number of qubits to go to
...
plt.legend()
plt.savefig('sparse_expm_comparison_plots/times_'+str(low)+'_to_'+str(high)+'_qubits_w_linalg.png')
...
plt.legend()
plt.savefig('sparse_expm_comparison_plots/improvement_'+str(low)+'_to_'+str(high)+'_qubits_w_linalg.png')
